  ...
  return (
    <Page>
      <Section className="overflow-hidden text-white rounded-lg dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col items-center justify-center py-4 px-4 mx-auto sm:p-5">
          <p className="p-2 text-sm font-medium tracking-wider text-center uppercase">
            Development team
          </p>
          <h1 className="mb-10 text-xl font-bold leading-none text-center sm:text-5xl">
